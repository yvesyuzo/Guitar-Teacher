...
***
O Guitar-Teacher vai ensinar o usuario a tocar guitarra ou violão.
...
#Para verificar se as notas estão corretas o programa ira reconhecer as 
#frequencias sonoras reproduzidas. Assim, o programa podera alem de dizer 
#se as notas estão certas, monstrar como elas devem ser tocadas.
